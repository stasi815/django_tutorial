...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        """ The detail view of a questionwith a pub_date in the future returns a 404 not found. """
    ...
    def test_past_question(self):
        """ The details view of a question with a pub_date in the past display's the question's text. """
